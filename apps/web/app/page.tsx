    ...
    <main className="min-h-screen">
      <header className="border-b-2 border-black p-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-3xl font-bold">InsurePool</h1>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="card">
          <h2 className="text-2xl font-bold mb-6">InsurePool Interface</h2>
      ...
      <footer className="border-t-2 border-black mt-12 p-6">
        <div className="max-w-7xl mx-auto text-center text-sm text-gray-600">
          <p>InsurePool © 2026 | Multi-Chain dApp | MIT License</p>
        </div>
      </footer>
    </main>
  )
