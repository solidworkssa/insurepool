# 26-insurepool - Base Native Architecture
...
InsurePool provides a decentralized solution for peer-to-peer insurance policies on both Base (EVM) and Stacks blockchains.
