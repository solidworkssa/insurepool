...
Decentralized insurance coverage pool protocol

## Overview

InsurePool is a decentralized application built on both Base (Ethereum L2) and Stacks (Bitcoin L2). It leverages the security of both chains to provide a robust and trustless experience.
